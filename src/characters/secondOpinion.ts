...
export const secondOpinion: Character = {
  name: "Second Opinion",
  description:
  ...
  describeHumanoid: () =>
    "Second Opinion is a meek woman who seems to be glancing around the room and, when she isn't, staring at the floor. She is of very below average build. Second Opinion is wearing a doctor's coat as if she had just finished her shift.",
};
